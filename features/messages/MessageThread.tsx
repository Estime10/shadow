...
export function MessageThread({ conversation, messages, showHeader = true }: Props) {
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-[var(--bg)]">
      ...
      {/* Messages : padding-bottom pour ne pas passer sous l'input fixe + nav + safe area (mobile-first) */}
      <div
