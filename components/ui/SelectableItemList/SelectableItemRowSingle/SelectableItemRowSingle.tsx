  ...
  return (
    <li>
      <button
        ...
        disabled={isDisabled}
        className="flex w-full md:cursor-pointer items-center gap-3 rounded-xl content-px py-3 text-left transition-colors md:hover:bg-(--bg) focus:outline-none focus-visible:ring-2 focus-visible:ring-accent disabled:opacity-60 disabled:pointer-events-none"
      >
